...
<div id="mySidenav" class="sidenav">
  ...
  <ul class="mainmenu">
    <li><a href="AddCourse.jsp" id="Chemisrty" target="frame1" onclick="Physics()">Add Course</a></li>
    <li><a href="" target="frame1" id="Json" onclick="Json()" >View Course</a>
	    <ul class="submenu">
	    <c:forEach var="CourseList" items="${Course_List}">
					
					<!-- set up a link for each student -->
					<c:url var="tempLink" value="ViewCoursesServlet" >
						<c:param name="gotopost" value="POST" />
    ...
    <!--onclick="Json('${CourseList}')"  <li><a href="" target="frame1" id="Physics" onclick="Physics()" >Discussion Board</a>
      <ul class="submenu">
        <li><a href="" target="frame1" id="Physics" onclick="Physics()" >Course1</a></li>
        <li><a href="" target="frame1" id="Physics" onclick="Physics()" >Course2</a></li>
        <li><a href="" target="frame1" id="Physics" onclick="Physics()" >Course3</a></li>
...
<div id="h_iframe1">
<iframe name="frame1"  width="100%" style="height: 100vh;"></iframe>
</div>

<!-- <iframe name="framess" id="framess" frameborder="0" width="100%" allowfullscreen></iframe> --> 
<script type="text/javascript">
function openNav() {
    document.getElementById("mySidenav").style.width = "250px";
    document.getElementById("main").style.marginLeft = "250px";
document.getElementById("h_iframe1").style.marginLeft = "250px";
document.getElementById("framess").style.marginLeft = "250px";
...
document.getElementById("framess").style.marginLeft = "0";
document.body.style.backgroundColor = "white"; 
}

function Json(courselist) {
	//document.getElementById("framess").src = "ViewPdf?coursename="+courselist+"";
}
