		...
		<div id="content">
			...
			<table style="width: 100%">
					<c:url var="tempLink" value="/GradcenterServlet">
						<c:param name="command" value="firstname" />
						<c:param name="column" value="first_name" />						
					</c:url>
					<c:url var="tempLink1" value="/GradcenterServlet">
						<c:param name="command" value="lastname" />
						<c:param name="column" value="last_name" />
				...
				<tr>
					<th><a href="${tempLink}" >First Name</a></th>
					<th><a href="${tempLink1}" >Last Name</a></th>
					<th><a href="${tempLink2}" >Courseid</a></th>
					<th><a href="${tempLink3}" >Grade</a></th>
				</tr>
