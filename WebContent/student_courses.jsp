...
<div id="mySidenav" class="sidenav">
  ...
  <ul class="mainmenu">
    <li><a href="ViewAllCourses" id="Chemisrty" target="frame1">View All Courses</a></li>
    <li><a href="" target="frame1" id="Json" onclick="Json()" >View Your Catalouge</a>
	    <ul class="submenu">
	    <c:forEach var="CourseList" items="${Course_List}">
					...
					<li><a href="${tempLink}" target="frame1" onclick="Json('${CourseList}')">${CourseList}</a></li>											
